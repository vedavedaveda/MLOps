...
This is our CI/CD pipeline, though we'll admit we're still working out some kinks. We develop locally and push code to GitHub, which triggers our GitHub Actions. The build process creates a Docker image that we store in an artifact registry.
